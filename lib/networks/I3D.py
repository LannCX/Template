...
class I3D(torch.nn.Module):
    def __init__(self,
        ...
        self.conv3d_0c_1x1 = Unit3Dpy(in_channels=1024, out_channels=self.num_classes, kernel_size=(1, 1, 1), activation=None, use_bias=True, use_bn=False)
    ...
    def forward(self, inp):
        ...
        # feature = out # extract feature from here
